  ...
  return (
    <>
      ...
      <div className='flex w-full h-screen pb-20 justify-center'>
        <div className='flex flex-col justify-center items-center text-center h-full w-2/5'>
          <div className='text-4xl mb-8 px-4 py-2 neon-text rounded-xl'>Matrix-Verse</div>
